...
using pruebaworkshop.Application.UseCase.V1.PersonOperation.Commands.Create;
using pruebaworkshop.Application.UseCase.V1.PersonOperation.Commands.Update;
